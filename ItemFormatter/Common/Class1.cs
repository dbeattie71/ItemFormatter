...
namespace ItemFormatter.Common
{
    public abstract class Mapper2
    {
        ...
        protected Mapper2(string bonusListPath)
        {
    ...
    public class ChatLogMapper : Mapper2
    {
        public ChatLogMapper(string bonusListPath) : base(bonusListPath)
        {
        }
    }
}
